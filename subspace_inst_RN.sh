...
sudo wget https://github.com/subspace/subspace/releases/download/snapshot-2022-may-18/subspace-node-ubuntu-x86_64-snapshot-2022-may-18

echo "=================================================="

echo -e "\e[1m\e[32m4. Downloading subspace farmer binary... \e[0m" && sleep 1
sudo wget https://github.com/subspace/subspace/releases/download/snapshot-2022-may-18/subspace-farmer-ubuntu-x86_64-snapshot-2022-may-18

echo "=================================================="

echo -e "\e[1m\e[32m5. Moving node to /usr/local/bin/subspace-node ... \e[0m" && sleep 1
sudo mv subspace-node-ubuntu-x86_64-snapshot-2022-may-18 /usr/local/bin/subspace-node

echo "=================================================="

echo -e "\e[1m\e[32m6. Moving farmer to /usr/local/bin/subspace-farmer ... \e[0m" && sleep 1
sudo mv subspace-farmer-ubuntu-x86_64-snapshot-2022-may-18 /usr/local/bin/subspace-farmer
